      ...
      body: ListView(
        children: [
          ListTile(
            ...
            subtitle: const Text('280.000 COP', style: TextStyle(fontSize: 13)),
            trailing: CircleAvatar(
              child: Obx(() => Text(controls.totalSaco.toString())),
            ),
          ),
          imagenRopa(ImagenaUsar: 'assets/imagen2.jpg',),
          ListTile(
            leading: const CircleAvatar(
              child: Icon(Icons.shopify_sharp),
            ),
            ...
            subtitle: const Text('239.000 COP', style: TextStyle(fontSize: 13)),
            trailing: CircleAvatar(
              child: Obx(() => Text(controls.totalChaqueta.toString())), 
            ),
            
          ),
          imagenRopa(ImagenaUsar: 'assets/imagen1.jpg',),
        ],
      ),
    );
  }
